...
public class TicketTypeController {
	...
	public ModelAndView ticketAndCount(@ModelAttribute TicketType ticket)
			throws IOException {
	...
	/*
	 * @RequestMapping(value = "/ticketlist") public ModelAndView listusers()
	 * throws IOException {
	 * 
	 ...
	 * 
	 * model.addObject("tickets", tickets); model.setViewName("AdminDasboard");
	 * return model;
	 * 
	 * }
	 */
	...
	public ModelAndView ticketupdate(HttpServletRequest request) {
		...
		ModelAndView model = new ModelAndView("TicketTypes", "ticket_type_id",
				ticket_type_id);
		return model;
