...
public class TicketTypeDaoImplements implements TicketTypeDaoInterface {
	...
	/*
	 * @Override public List<TicketType> ticketCount() { // TODO Auto-generated
	 * method stub String sql = "SELECT * FROM ticket_type";
	 * 
	 * List<TicketType> ticket = getJdbcTemplate().query(sql, new
	 * BeanPropertyRowMapper(TicketType.class));
	 * 
	 * return ticket; }
	 */
