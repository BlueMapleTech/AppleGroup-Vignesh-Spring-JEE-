...
public class TimingsDaoImplements implements TimingsDaoInterface {
	...
	/*
	 * @Override public List<Timings> timelist() { // TODO Auto-generated method
	 * stub String sql = "SELECT * FROM timings";
	 * 
	 * List<Timings> time = getJdbcTemplate().query(sql, new
	 * BeanPropertyRowMapper(Timings.class));
	 * 
	 * return time; }
	 */
